...
import vinx.material.fastscroll.DefaultAnimationHelper;
import vinx.material.fastscroll.FastScrollWebView;
...
public class FastScrollerBuilder {
    ...
    @Nullable
    private vinx.material.fastscroll.PopupTextProvider mPopupTextProvider;
    ...
    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setViewHelper(@Nullable FastScroller.ViewHelper viewHelper) {
        mViewHelper = viewHelper;
        return this;
    }

    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setPopupTextProvider(@Nullable PopupTextProvider popupTextProvider) {
        mPopupTextProvider = popupTextProvider;
        return this;
    }

    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setPadding(int left, int top, int right, int bottom) {
        if (mPadding == null) {
            mPadding = new Rect();
        }
    ...
    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setPadding(@Nullable Rect padding) {
        if (padding != null) {
            if (mPadding == null) {
                mPadding = new Rect();
            }
    ...
    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setTrackDrawable(@NonNull Drawable trackDrawable) {
        mTrackDrawable = trackDrawable;
        return this;
    }

    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setThumbDrawable(@NonNull Drawable thumbDrawable) {
        mThumbDrawable = thumbDrawable;
        return this;
    }

    @NonNull
    public vinx.material.fastscroll.FastScrollerBuilder setPopupStyle(@NonNull Consumer<TextView> popupStyle) {
    ...
    public void disableScrollbarAutoHide() {
        vinx.material.fastscroll.DefaultAnimationHelper animationHelper = new vinx.material.fastscroll.DefaultAnimationHelper(mView);
